...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-tag-parser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11975&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-tag-parser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-tag-parser` can be installed with:

```
conda install django-tag-parser
```

It is possible to list all of the versions of `django-tag-parser` available on your platform with:
